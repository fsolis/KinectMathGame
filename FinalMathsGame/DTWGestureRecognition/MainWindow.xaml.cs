...
namespace DTWGestureRecognition
{
    ...
    public partial class MainWindow
    {
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (randomNumber == 0)
            {
                number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/0.png", UriKind.Relative));
                ...
                if (randomNumber == 1)
                {
                    number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/1.png", UriKind.Relative));
                    number1questionconst = 1.00m;
                }
                else
                    if (randomNumber == 2)
                    {
                        number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/2.png", UriKind.Relative));
                        number1questionconst = 2.00m;
                    }
                    else
                        if (randomNumber == 3)
                        {
                            number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/3.png", UriKind.Relative));
                            number1questionconst = 3.00m;
                        }
                        else
                            if (randomNumber == 4)
                            {
                                number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/4.png", UriKind.Relative));
                                number1questionconst = 4.00m;
                            }
                            else
                                if (randomNumber == 5)
                                {
                                    number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/5.png", UriKind.Relative));
                                    number1questionconst = 5.00m;
                                }
                                else
                                    if (randomNumber == 6)
                                    {
                                        number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/6.png", UriKind.Relative));
                                        number1questionconst = 6.00m;
                                    }
                                    else
                                        if (randomNumber == 7)
                                        {
                                            number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/7.png", UriKind.Relative));
                                            number1questionconst = 7.00m;
                                        }
                                        else
                                            if (randomNumber == 8)
                                            {
                                                number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/8.png", UriKind.Relative));
                                                number1questionconst = 8.00m;
                                            }
                                            else
                                                if (randomNumber == 9)
                                                {
                                                    number1.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/9.png", UriKind.Relative));
            ...
            if (randomNumber2 == 0)
            {
                number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/0.png", UriKind.Relative));
                number2questionconst = 0.00m;
            }
            else
                if (randomNumber2 == 1)
                {
                    number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/1.png", UriKind.Relative));
                    number2questionconst = 1.00m;
                }
                else
                    if (randomNumber2 == 2)
                    {
                        number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/2.png", UriKind.Relative));
                        number2questionconst = 2.00m;
                    }
                    else
                        if (randomNumber2 == 3)
                        {
                            number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/3.png", UriKind.Relative));
                            number2questionconst = 3.00m;
                        }
                        else
                            if (randomNumber2 == 4)
                            {
                                number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/4.png", UriKind.Relative));
                                number2questionconst = 4.00m;
                            }
                            else
                                if (randomNumber2 == 5)
                                {
                                    number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/5.png", UriKind.Relative));
                                    number2questionconst = 5.00m;
                                }
                                else
                                    if (randomNumber2 == 6)
                                    {
                                        number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/6.png", UriKind.Relative));
                                        number2questionconst = 6.00m;
                                    }
                                    else
                                        if (randomNumber2 == 7)
                                        {
                                            number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/7.png", UriKind.Relative));
                                            number2questionconst = 7.00m;
                                        }
                                        else
                                            if (randomNumber2 == 8)
                                            {
                                                number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/8.png", UriKind.Relative));
                                                number2questionconst = 8.00m;
                                            }
                                            else
                                                if (randomNumber2 == 9)
                                                {
                                                    number2.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/9.png", UriKind.Relative));
            ...
            {
                case 0:
                    //opp.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/multiply.png", UriKind.Relative));
                    number3operatorconst = "*";
                    answertoquestion = number1questionconst * number2questionconst;
                    //answerbox.Text = Convert.ToString(answertoquestion);
                    answerbox.Text = answertoquestion.ToString("N2");
                    break;
                case 1:
                    //opp.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/divide.png", UriKind.Relative));
                    number3operatorconst = "/";
                    answertoquestion = number1questionconst / number2questionconst;
                    //answerbox.Text = Convert.ToString(answertoquestion);
                    answerbox.Text = answertoquestion.ToString("N2");
                    break;
                case 2:
                    //opp.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/plus.png", UriKind.Relative));
                    number3operatorconst = "+";
                    answertoquestion = number1questionconst + number2questionconst;
                    //answerbox.Text = Convert.ToString(answertoquestion);
                    answerbox.Text = answertoquestion.ToString("N2");
                    break;
                case 3:
                    //opp.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/subtract.png", UriKind.Relative));
                    number3operatorconst = "subtract";
                    answertoquestion = number1questionconst - number2questionconst;
                    //string formatted = answertoquestion.ToString("N2");
                    answerbox.Text = answertoquestion.ToString("N2");
                    break;
                case 4:
                    //opp.Source = new BitmapImage(new Uri("/DTWGestureRecognition;component/Images/subtract.png", UriKind.Relative));
        ...
        private void videoImage_ImageFailed(object sender, ExceptionRoutedEventArgs e)
        {
